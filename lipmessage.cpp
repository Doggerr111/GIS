...
LIPMessage &LIPMessage::getInstance()
{
    static LIPMessage instance;
    return instance;
}

void LIPMessage::setMainWindow(QMainWindow *mainWindow)
{
    mMainWindow = mainWindow;
}

void LIPMessage::showMessage(const QString &errorMessage, int msec, messageStatus st)
{
